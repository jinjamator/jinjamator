...
.. toctree::
    ...
    vmware.vsphere.datastore.cluster.rst


.. py:function:: vmware.vsphere.datastore.get(attr_name, attr_value, obj, **kwargs):
...
.. py:function:: vmware.vsphere.datastore.get_datastore_cluster(obj):
...
.. py:function:: vmware.vsphere.datastore.get_dict(obj, **kwargs):

    This function is not yet implemented
    

.. py:function:: vmware.vsphere.datastore.get_host_mounts(obj):
...
.. py:function:: vmware.vsphere.datastore.get_hosts(obj):
...
.. py:function:: vmware.vsphere.datastore.get_list(obj, **kwargs):
...
.. py:function:: vmware.vsphere.datastore.get_vms(obj, **kwargs):
...
.. py:function:: vmware.vsphere.datastore.is_clustered(obj):
...
.. py:function:: vmware.vsphere.datastore.is_datastore(obj):
...
.. py:function:: vmware.vsphere.datastore.is_type(obj):
