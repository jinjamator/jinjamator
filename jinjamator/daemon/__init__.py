...
def configure(flask_app, _configuration):
    ...
    flask_app.config["CELERY_RESULT_BACKEND"] = _configuration.get("celery_result_backend")
    flask_app.config["SQLALCHEMY_DATABASE_URI"] = _configuration.get("celery_result_backend")
    flask_app.config["JINJAMATOR_BASE_DIRECTORY"] = _configuration.get("jinjamator_base_directory")
    flask_app.config["UPLOAD_FOLDER"] = "/tmp"
    flask_app.config["JINJAMATOR_GLOBAL_DEFAULTS"] = _configuration.get("global_defaults")
    flask_app.config["JINJAMATOR_TASKS_BASE_DIRECTORIES"] = _configuration.get("global_tasks_base_dirs")
    flask_app.config["JINJAMATOR_ENVIRONMENTS_BASE_DIRECTORIES"] = _configuration.get("global_environments_base_dirs")
    flask_app.config["JINJAMATOR_OUTPUT_PLUGINS_BASE_DIRS"] = _configuration.get("global_output_plugins_base_dirs")
    flask_app.config["JINJAMATOR_CONTENT_PLUGINS_BASE_DIRS"] = _configuration.get("global_content_plugins_base_dirs")
